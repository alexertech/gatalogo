...
class RazasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create raza" do
    assert_difference("Raza.count") do
      post razas_url, params: { raza: { descripcion: @raza.descripcion, nombre: @raza.nombre } }
    end
  ...
  test "should update raza" do
    patch raza_url(@raza), params: { raza: { descripcion: @raza.descripcion, nombre: @raza.nombre } }
